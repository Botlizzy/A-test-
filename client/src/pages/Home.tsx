...
function HomeApiSkeleton({ message }: { message: string }) {
  return <div className="homepage-api-skeleton" role="status" aria-live="polite"><span className="premium-skeleton premium-skeleton--icon" /><div><strong>Working on it</strong><p>{message}</p></div><div className="homepage-api-skeleton__lines"><span className="premium-skeleton" /><span className="premium-skeleton" style={{ width: "58%" }} /></div></div>;
}

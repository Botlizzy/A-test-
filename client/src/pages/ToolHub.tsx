...
type ToolHubProps = { user?: User; onBack: () => void; onSignOut: () => Promise<void>; embedded?: boolean; hiddenCategories?: string[]; hiddenPaths?: string[] };
...
export default function ToolHub({ user, onBack, onSignOut, embedded = false, hiddenCategories = [], hiddenPaths = [] }: ToolHubProps) {

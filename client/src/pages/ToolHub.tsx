...
type ToolHubProps = { user?: User; onBack: () => void; onSignOut: () => Promise<void>; embedded?: boolean };
...
export default function ToolHub({ user, onBack, onSignOut, embedded = false }: ToolHubProps) {

    ...
    <div className="auth-shell">
      ...
      <main className="auth-layout">
        ...
        <section className="auth-card">
          ...
          <div className="auth-switch"><span>{mode === "login" ? "New to ELIZZY DOMAIN?" : "Already have an account?"}</span><button onClick={() => switchMode(mode === "login" ? "signup" : "login")}>{mode === "login" ? "Create account" : "Sign in"}</button></div>

...
export default function PremiumWebBuilder() {
  ...
  return <section className="premium-web-builder" id="premium-web-builder">
    ...
    {generate.isPending && <div className="premium-web-builder__status" role="status" aria-live="polite"><LoaderCircle size={18} className="spin" /><div><strong>AI coder is building your project</strong><p>Sending your brief, assembling the code package, and preparing a downloadable ZIP. Keep this panel open.</p><div className="premium-tool-skeleton__rows" aria-hidden="true"><span className="premium-skeleton" /><span className="premium-skeleton" style={{ width: "68%" }} /><span className="premium-skeleton" style={{ width: "42%" }} /></div></div></div>}

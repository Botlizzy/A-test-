  ...
  return (
    <main className="maintenance-page">
      ...
      <section className="maintenance-card" aria-labelledby="maintenance-title">
        <div className="maintenance-brand"><span className="brand-mark"><span className="signal-mark"><span /><span /><span /></span></span><span><strong>eliminator</strong><em>streaming</em></span></div>
        ...
        <p>Eliminator is currently under maintenance while we improve the experience. Please check back shortly.</p>
